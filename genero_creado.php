        ...
        ?> 
            <div class="containter-fluid">
                <div class="alert alert-success text-center" role="alert">
                    ...
                    </svg> Genero Guardado Satisfactoriamente!
                </div>	
            </div>    
        <?php					
        }
        ...
        ?> 
            <div class="containter-fluid">    
                <div class="alert alert-danger text-center" role="alert">
                    ...
                    </svg> No se puede Guardar el Género!
                </div>	
            </div>              
        <?php
        }        
    ...
    ?>
        ...
        <form action="administrador.php" method="POST">				
            <div class="form-group row justify-content-center">
              <label for="inputGenero" class="col-sm-1 col-form-label text-sm-right">Género:</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" id="inputGenero" name="inputGenero" value="<?php echo $genero; ?>" readonly>
              </div>
            </div>          
