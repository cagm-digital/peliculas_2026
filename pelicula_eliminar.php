...
<html lang="es">
  <head>
    ...
    <title>Eliminar Película - ITS</title>
            ...
            <div class="col-md-5">
                <div class="card shadow border-0">
                    ...
                    <div class="card-body p-4 text-center">
                        <p class="mb-4">¿Está seguro de que desea eliminar la siguiente película?</p>
                        <h2 class="text-danger fw-bold mb-4"><?php echo $datos['nombre']; ?></h2>
                        
                        <form action="pelicula_eliminada.php" method="POST">
