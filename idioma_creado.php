 ...
 <head>
  ...
  <body>
    ...
    <?php
        ...
        {			
            echo '<div class="alert alert-success text-center" role="alert">¡Idioma registrado exitosamente!</div>';
        }
        else
        {						
            echo '<div class="alert alert-danger text-center" role="alert">Error al registrar el idioma.</div>';
        }
        mysqli_close($idCone);	
    ?>
        ...
        <form action="administrador.php" method="POST">				
            <div class="form-group row justify-content-center">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="inputIdioma" value="<?php echo htmlspecialchars($idioma); ?>" readonly>
              </div>
            </div>          
