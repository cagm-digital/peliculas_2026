...
<html lang="es">
 <head>
    ...
    <title>Listado de Géneros - ITS 2026</title>
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-danger">
                            <tr>
                                ...
                                <th scope="col" class="py-3">Nombre del Género</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="genero_modificar.php?id=<?php echo $row['id']; ?>" 
                                    class="btn btn-outline-warning btn-sm shadow-sm me-2">
                                        <i class="bi bi-pencil-square"></i> Editar
                                    </a>
                                    
                                    <a href="genero_eliminar.php?id=<?php echo $row['id']; ?>" 
